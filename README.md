...
* Just run:
```
apt install git -y && git clone https://github.com/hyperio546/termux-xfce && ./install.sh
``` 
...
* Run:
```
git clone https://github.com/hyperio546/termux-xfce && ./theme.sh
```
...
- Run: 
```
git clone https://github.com/hyperio546/termux-xfce && ./uninstall.sh
```
